...
from .generation import CompileConfig, GenerationConfig, GenerationMixin, ContinuousMixin
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, ContinuousMixin, PushToHubMixin, PeftAdapterMixin):
    r"""
