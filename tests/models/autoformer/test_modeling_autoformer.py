...
class AutoformerModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    @is_flaky(reason="The computation of `tmp_delay` in `AutoformerAttention.forward` seems wrong, see PR #12345. Also `topk` is used to compute indices which is not stable.")
